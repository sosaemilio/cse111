...
def main():
    try:
        ...
        with open(filename, "rt") as text_file:
            ...
            for row in reader:
                ...
                try:
                    ...
                    print(f"{zero_error} on line {row_number}")
        ...
        print(f"[Errno 2] No such file or directory: '{filename}' Please choose a different file.")
    except PermissionError as error:
        print(f"[Errno 13] Permission denied: '{filename}.csv'Please choose a different file.")
