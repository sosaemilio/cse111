...
def print_marriages(marriages_dict, people_dict):
    ...
    for id, person in marriages_dict.items():
        husband_key = person[HUSBAND_KEY_INDEX]
        wife_key = person[WIFE_KEY_INDEX]
        wedding_year = person[WEDDING_YEAR_INDEX]
        ...
        print(f"Husband: {husband_name} - Wife: {wife_name} - Year: {wedding_year}")
