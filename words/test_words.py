...
def test_suffix():
    ...
    # Call the sufix function store to values, and verify it returns a string
    su = suffix("upbeat", "upgrade")
    assert isinstance(su, str), "check if the function return a string"

    # Call the sufi fucntion and test multiple times.
